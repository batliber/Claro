...
<%@ page import="uy.com.amensg.claro.dwr.UsuarioDWR"  %>
<%@ page import="uy.com.amensg.claro.entities.UsuarioTO"  %>
<%@ page import="uy.com.amensg.claro.entities.MenuTO"  %>

<%@ page import="javax.naming.Context" %>
<%@ page import="javax.naming.InitialContext" %>

<%@ page import="uy.com.amensg.claro.bean.ISeguridadBean"  %>
<%@ page import="uy.com.amensg.claro.bean.IUsuarioBean"  %>
<%@ page import="uy.com.amensg.claro.bean.SeguridadBean"  %>
<%@ page import="uy.com.amensg.claro.bean.UsuarioBean"  %>
<%@ page import="uy.com.amensg.claro.entities.Usuario"  %>
<%@ page import="uy.com.amensg.claro.entities.UsuarioTO"  %>
...
%>
	...
	<div class="inactiveMenuBarItem">
		<div id="divLogo"><img id="imgLogo" src="/ClaroWEB/images/logo-vos-bw.png"/></div>
	</div>
